...
**
** Created: Wed Aug 13 10:02:56 2014
...
static const char qt_meta_stringdata_browserwindow[] = {
    "browserwindow\0\0adjustLocation()\0"
    "adjustTitle()\0p\0setProgress(int)\0"
    "finishLoading(bool)\0"
};
...
void browserwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->adjustTitle(); break;
        case 2: _t->setProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->finishLoading((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
