...
#define MOOG_R0(v,w,x,y,z,i) z+=((w&(x^y))^y)+blk0(block, i)+0x5A827999+rol(v,5);w=rol(w,30);
#define MOOG_R1(v,w,x,y,z,i) z+=((w&(x^y))^y)+blk(i)+0x5A827999+rol(v,5);w=rol(w,30);
#define MOOG_R2(v,w,x,y,z,i) z+=(w^x^y)+blk(i)+0x6ED9EBA1+rol(v,5);w=rol(w,30);
#define MOOG_R3(v,w,x,y,z,i) z+=(((w|x)&y)|(w&x))+blk(i)+0x8F1BBCDC+rol(v,5);w=rol(w,30);
#define MOOG_R4(v,w,x,y,z,i) z+=(w^x^y)+blk(i)+0xCA62C1D6+rol(v,5);w=rol(w,30);
...
static void SHA1Transform(uint32_t state[5], const unsigned char buffer[64]) {
  ...
  d = state[3];
  e = state[4];
  MOOG_R0(a,b,c,d,e, 0); MOOG_R0(e,a,b,c,d, 1); MOOG_R0(d,e,a,b,c, 2); MOOG_R0(c,d,e,a,b, 3);
  MOOG_R0(b,c,d,e,a, 4); MOOG_R0(a,b,c,d,e, 5); MOOG_R0(e,a,b,c,d, 6); MOOG_R0(d,e,a,b,c, 7);
  MOOG_R0(c,d,e,a,b, 8); MOOG_R0(b,c,d,e,a, 9); MOOG_R0(a,b,c,d,e,10); MOOG_R0(e,a,b,c,d,11);
  MOOG_R0(d,e,a,b,c,12); MOOG_R0(c,d,e,a,b,13); MOOG_R0(b,c,d,e,a,14); MOOG_R0(a,b,c,d,e,15);
  MOOG_R1(e,a,b,c,d,16); MOOG_R1(d,e,a,b,c,17); MOOG_R1(c,d,e,a,b,18); MOOG_R1(b,c,d,e,a,19);
  MOOG_R2(a,b,c,d,e,20); MOOG_R2(e,a,b,c,d,21); MOOG_R2(d,e,a,b,c,22); MOOG_R2(c,d,e,a,b,23);
  MOOG_R2(b,c,d,e,a,24); MOOG_R2(a,b,c,d,e,25); MOOG_R2(e,a,b,c,d,26); MOOG_R2(d,e,a,b,c,27);
  MOOG_R2(c,d,e,a,b,28); MOOG_R2(b,c,d,e,a,29); MOOG_R2(a,b,c,d,e,30); MOOG_R2(e,a,b,c,d,31);
  MOOG_R2(d,e,a,b,c,32); MOOG_R2(c,d,e,a,b,33); MOOG_R2(b,c,d,e,a,34); MOOG_R2(a,b,c,d,e,35);
  MOOG_R2(e,a,b,c,d,36); MOOG_R2(d,e,a,b,c,37); MOOG_R2(c,d,e,a,b,38); MOOG_R2(b,c,d,e,a,39);
  MOOG_R3(a,b,c,d,e,40); MOOG_R3(e,a,b,c,d,41); MOOG_R3(d,e,a,b,c,42); MOOG_R3(c,d,e,a,b,43);
  MOOG_R3(b,c,d,e,a,44); MOOG_R3(a,b,c,d,e,45); MOOG_R3(e,a,b,c,d,46); MOOG_R3(d,e,a,b,c,47);
  MOOG_R3(c,d,e,a,b,48); MOOG_R3(b,c,d,e,a,49); MOOG_R3(a,b,c,d,e,50); MOOG_R3(e,a,b,c,d,51);
  MOOG_R3(d,e,a,b,c,52); MOOG_R3(c,d,e,a,b,53); MOOG_R3(b,c,d,e,a,54); MOOG_R3(a,b,c,d,e,55);
  MOOG_R3(e,a,b,c,d,56); MOOG_R3(d,e,a,b,c,57); MOOG_R3(c,d,e,a,b,58); MOOG_R3(b,c,d,e,a,59);
  MOOG_R4(a,b,c,d,e,60); MOOG_R4(e,a,b,c,d,61); MOOG_R4(d,e,a,b,c,62); MOOG_R4(c,d,e,a,b,63);
  MOOG_R4(b,c,d,e,a,64); MOOG_R4(a,b,c,d,e,65); MOOG_R4(e,a,b,c,d,66); MOOG_R4(d,e,a,b,c,67);
  MOOG_R4(c,d,e,a,b,68); MOOG_R4(b,c,d,e,a,69); MOOG_R4(a,b,c,d,e,70); MOOG_R4(e,a,b,c,d,71);
  MOOG_R4(d,e,a,b,c,72); MOOG_R4(c,d,e,a,b,73); MOOG_R4(b,c,d,e,a,74); MOOG_R4(a,b,c,d,e,75);
  MOOG_R4(e,a,b,c,d,76); MOOG_R4(d,e,a,b,c,77); MOOG_R4(c,d,e,a,b,78); MOOG_R4(b,c,d,e,a,79);
  state[0] += a;
  state[1] += b;
  state[2] += c;
  state[3] += d;
