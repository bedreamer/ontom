...
TOOLS="scripts/installcard.sh testing/uartread testing/uartwrite testing/bcc thirdpart/bc-1.06.95/bc/bc thirdpart/bc-1.06.95/dc/dc testing/sqlite3-arm scripts/runme.sh scripts/automount.sh scripts/export.sh scripts/upgrade.sh scripts/preconfig.sh"
